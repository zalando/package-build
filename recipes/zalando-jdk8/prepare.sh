...
[ -f $JDK_TARGET ] || curl -jkLH 'Cookie: oraclelicense=accept-securebackup-cookie' --progress-bar -o $JDK_TARGET http://download.oracle.com/otn-pub/java/jdk/8u${VERSION}-b16/jdk-8u${VERSION}-linux-x64.tar.gz
